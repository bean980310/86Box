...
const machine_t machines[] = {
    ...
    { "[8088] IBM Portable PC (1982)",			"ibmportablepc",		MACHINE_TYPE_8088,		CPU_PKG_8088, 0, 0, 0, 0, 0, 0, 0,										MACHINE_PC,									   64,   256,  64,    0,		      machine_xtportable_init, NULL			},
    ...
    { "[ISA] IBM AT (1985)",				"ibmat85",		MACHINE_TYPE_286,		CPU_PKG_286, 0, 6000000, 0, 0, 0, 0, 0,									MACHINE_AT,									  256, 15872, 128,   63,		  machine_at_ibm85_init, NULL			},
    { "[ISA] IBM AT (1985, 8Mhz Var1)",				"ibmat851",		MACHINE_TYPE_286,		CPU_PKG_286, 0, 8000000, 0, 0, 0, 0, 0,									MACHINE_AT,									  256, 15872, 128,   63,		  machine_at_ibm851_init, NULL			},
    { "[ISA] IBM AT (1985, 8Mhz Var2)",				"ibmat852",		MACHINE_TYPE_286,		CPU_PKG_286, 0, 8000000, 0, 0, 0, 0, 0,									MACHINE_AT,									  256, 15872, 128,   63,		  machine_at_ibm852_init, NULL			},
    ...
    { "[ISA] Compaq Deskpro 386",	"deskpro386",       MACHINE_TYPE_386DX,		CPU_PKG_386DX, 0, 0, 0, 0, 0, 0, 0,										MACHINE_AT | MACHINE_IDE,					 1024, 14336, 1024, 127,       machine_at_portableiii386_init, NULL	},
